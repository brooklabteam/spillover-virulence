...
This repository compiles code for [Brook et al. 2023](https://doi.org/10.1371/journal.pbio.3002268), "Reservoir host immunology and life history shape virulence evolution in zoonotic viruses", published in *PLoS Biology*. You should be able to reproduce all analyses by cloning this repo to your computer and editing the "homewd" address to your own working directory at the top of each R-script. 

There are eleven main folders:
...
- archive: contains old scripts used in previous versions of the figures that did not make it into the final paper