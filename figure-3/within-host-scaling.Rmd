...
We can then use the fitted model to estimate $g_0$ for our within-host model. Our goal is for g0 to span 0 to 1 for model parameterization. We only allow for linear transformations of the data, in order 
