...
<img "/brief/Fig1.png" alt = "Example Fig. 1" width="600">
...
<img "/brief/Fig2.png" alt = "Example Fig. 2" width="400">


We see clear evidence of significant effects of host order on the relationship between body mass and longevity. 

In particular, significant positive associations with longevity, indicative of orders with longer lifespans than predicted by body size are:
1. Chiroptera 
2. Cingulata
3. Monotremata
4. Primates
...
Significant negative associations, indicative of orders with shorter lifespans than predicted by body size are:
...
<img "/brief/Fig3.png" alt = "Example Fig. 3" width="500">
...
As a result, we opted to parameterize ($T_w$), host tolerance of immunopathology, from the same regression of host longevity against body mass ([Example Fig. 1, above](briefFig1.png)). Since the raw values for $T_w$ lack units in our within-host model, we can scale $T_w$ from the partial effects of host order on the interaction between mass and lifespan:
...
<img "/brief/Fig4.png" alt = "Example Fig. 4" width="500">
...
First, we downloaded data pairing neutrophil concentrations across XX mammalian species and spanning XX distinct orders from the Species360 database cited in [Downs et al. 2020](https://www.journals.uchicago.edu/doi/full/10.1086/706235) and linked it with [Pantheria](https://doi.org/10.1890/08-1494.1) data highlighted above:
...
<img "/brief/Fig5.png" alt = "Example Fig. 5" width="500">
...
<img "/brief/Fig6.png" alt = "Example Fig. 6" width="500">
...
# plot the partial effects from m3
...
<img "/brief/Fig7.png" alt = "Example Fig. 7" width="400">
...
We can then use the fitted model to estimate $g[0]$ for our within-host model. Our goal is for g0 to span 0 to 1 for model parameterization. We only allow for linear transformations of the data, in order 
to retain differences in the magnitude of effect. We add to the predict.dat database from above among the orders and plot $g[0]$ across orders:
...
Here, we estimate the $T[vS]$ parameter from these relationships and plot across mammalian orders:
...
<img "/brief/Fig9.png" alt = "Example Fig. 9" width="500">
...
<img "/brief/Fig11.png" alt = "Example Fig. 11" width="500">
...
<img "/brief/Fig12.png" alt = "Example Fig. 12" width="500">
...
#plot.dat$alpha[plot.dat$source=="predicted from zoonoses"] <- plot.dat$alpha[plot.dat$source=="predicted from zoonoses"]*1000
#plot.dat$alpha_lci[plot.dat$source=="predicted from zoonoses"] <- plot.dat$alpha_lci[plot.dat$source=="predicted from zoonoses"]*1000
#plot.dat$alpha_uci[plot.dat$source=="predicted from zoonoses"] <- plot.dat$alpha_uci[plot.dat$source=="predicted from zoonoses"]*1000
...
<img "/brief/Fig14.png" alt = "Example Fig. 14" width="500">

And here just the orders with comparison:

<img "/brief/Fig14_sub.png" alt = "Example Fig. 14" width="500">

And we can plot these predictions from complete tolerance assumptions, here with rabies included across the whole dataset:

<img "/brief/Fig15.png" alt = "Example Fig. 15" width="500">

And the subset of comparative orders:

<img "/brief/Fig15_sub.png" alt = "Example Fig. 15" width="500">

And here with rabies excluded as well:

<img "/brief/Fig16.png" alt = "Example Fig. 16" width="500">

And the subset of comparative orders:

<img "/brief/Fig16_sub.png" alt = "Example Fig. 16" width="500">
