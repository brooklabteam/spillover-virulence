...
First, we downloaded data pairing neutrophil concentrations across 246 mammalian species and spanning 16 distinct orders from the Species360 database cited in [Downs et al. 2020](https://www.journals.uchicago.edu/doi/full/10.1086/706235) and linked it with data from [Jones et al. 2009](https://doi.org/10.1890/08-1494.1) and [Healy et. al. 2014](https://doi.org/10.1098/rspb.2014.0298), highlighted above:
