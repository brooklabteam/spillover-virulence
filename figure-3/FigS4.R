# This is the script to produce Fig S4. 
...
FigS4 <- cowplot::plot_grid(p1,p2,p3,p4, nrow=4, ncol=1, rel_heights = c(1.05,1,1,1.3), labels = c("A", "B", "C", "D"), label_size = 22, label_x = -.01)
