...
p1 <- ggplot(data = subset(dat.compare, !is.na(lit_alpha))) + theme_bw() +
...
ggsave(file =paste0(homewd,"supp-figs/Fig_S6.png"),
       plot = p1,
       units="mm",  
       width=65, 
       height=80, 
...
#and plot
ggplot(data=plot.dat) + geom_point(aes(x= dat.constant))